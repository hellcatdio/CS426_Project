...
Authors: Addison Junkins and Rosa Farinaccio
...
2. Once all the dependencies are installed, simply type into terminal:
        python python_stegano batch-hide
            -This is to hide a stack of images with the same hidden file message.

3. You can reveal a message for a particular image by simply doing:
